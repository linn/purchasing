namespace Linn.Purchasing.Facade.Services
{
    ...
    public abstract class FacadeResourceService2<T, TKey, TResource, TUpdateResource> : IFacadeResourceService2<T, TKey, TResource, TUpdateResource>
    {
        ...
        public IResult<TResource> Add(TResource resource, IEnumerable<string> privileges = null)
        {
            T entity;
        ...
        public IResult<TResource> Update(TKey id, TUpdateResource updateResource, IEnumerable<string> privileges = null)
        {
            var entity = this.FindById(id);
            if (entity == null)
            {

namespace Linn.Purchasing.Facade.Services
{
    ...
    public interface IFacadeResourceService2<T, in TKey, TResource, in TUpdateResource>
    {
        ...
        IResult<TResource> Add(TResource resource, IEnumerable<string> privileges = null);

        IResult<TResource> Update(TKey id, TUpdateResource updateResource, IEnumerable<string> privileges = null);

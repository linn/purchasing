    ...
    public static class PersistenceExtensions
    {
        public static IServiceCollection AddPersistence(this IServiceCollection services)
        {
            return services.AddScoped<ServiceDbContext>().AddTransient<DbContext>(a => a.GetService<ServiceDbContext>())
                ...
                .AddTransient<IRepository<Person, int>,
                ...
                .AddTransient<IRepository<Organisation, int>,
                    EntityFrameworkRepository<Organisation, int>>(
                    r => new EntityFrameworkRepository<Organisation, int>(
                        r.GetService<ServiceDbContext>()?.Organisations))
                .AddTransient<IRepository<TqmsJobref, string>,
                    EntityFrameworkRepository<TqmsJobref, string>>(
                ...
                .AddTransient<IRepository<MrpRunLog, int>,
                    EntityFrameworkRepository<MrpRunLog, int>>(
                ...
                .AddTransient<ISingleRecordRepository<MrMaster>,
                    EntityFrameworkSingleRecordRepository<MrMaster>>(
                    r => new EntityFrameworkSingleRecordRepository<MrMaster>(
                        r.GetService<ServiceDbContext>()?.MrMaster))
                .AddTransient<IRepository<LinnWeek, int>,
                    EntityFrameworkRepository<LinnWeek, int>>(
                    r => new EntityFrameworkRepository<LinnWeek, int>(r.GetService<ServiceDbContext>()?.LinnWeeks))
                .AddTransient<IRepository<LedgerPeriod, int>,
                    EntityFrameworkRepository<LedgerPeriod, int>>(
                    r => new EntityFrameworkRepository<LedgerPeriod, int>(
                        r.GetService<ServiceDbContext>()?.LedgerPeriods))
                .AddTransient<IRepository<EdiOrder, int>,
                    EntityFrameworkRepository<EdiOrder, int>>(
                ...
                .AddTransient<IQueryRepository<StockLocator>,
                    EntityFrameworkQueryRepository<StockLocator>>(
                    r => new EntityFrameworkQueryRepository<StockLocator>(
                        r.GetService<ServiceDbContext>()?.StockLocators))
                .AddTransient<IQueryRepository<MrUsedOnRecord>,
                    EntityFrameworkQueryRepository<MrUsedOnRecord>>(
                    r => new EntityFrameworkQueryRepository<MrUsedOnRecord>(
                        r.GetService<ServiceDbContext>()?.MrUsedOnView))
                .AddTransient<IQueryRepository<PartAndAssembly>,
                    EntityFrameworkQueryRepository<PartAndAssembly>>(
                ...
                .AddTransient<IQueryRepository<EdiSupplier>,
                    EntityFrameworkQueryRepository<EdiSupplier>>(
                    r => new EntityFrameworkQueryRepository<EdiSupplier>(
                        r.GetService<ServiceDbContext>()?.EdiSuppliers))
                .AddTransient<IQueryRepository<ShortagesEntry>,
                    EntityFrameworkQueryRepository<ShortagesEntry>>(

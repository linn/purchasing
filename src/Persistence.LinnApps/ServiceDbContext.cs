namespace Linn.Purchasing.Persistence.LinnApps
{
    ...
    public class ServiceDbContext : DbContext
    {
        ...
        public DbSet<PurchaseOrderLogEntry> PurchaseOrderLog { get; set; }
        
        public DbSet<PurchaseOrderDetailLogEntry> PurchaseOrderDetailLog { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            this.BuildPurchaseOrderLogs(builder);
            this.BuildPurchaseOrderDetailLogs((builder));
        }
        ...
        private void BuildPurchaseOrders(ModelBuilder builder)
        {
            ...
            entity.Property(o => o.SupplierId).HasColumnName("SUPP_SUPPLIER_ID").HasMaxLength(6);
            entity.HasOne(o => o.Supplier).WithMany().HasForeignKey(o => o.SupplierId);
            entity.Property(o => o.DocumentTypeName).HasColumnName("DOCUMENT_TYPE").HasMaxLength(6);
            ...
            entity.Property(o => o.Overbook).HasColumnName("OVERBOOK").HasMaxLength(1);
            entity.Property(o => o.OverbookQty).HasColumnName("OVERBOOK_QTY").HasMaxLength(19);
            entity.Property(o => o.CurrencyCode).HasColumnName("CURR_CODE").HasMaxLength(4);
            entity.HasOne(o => o.Currency).WithMany().HasForeignKey(o => o.CurrencyCode);
            entity.Property(o => o.OrderContactName).HasColumnName("CONTACT_NAME").HasMaxLength(52);
            entity.HasMany(o => o.Details).WithOne(d => d.PurchaseOrder).HasForeignKey(d => d.OrderNumber);
            entity.Property(o => o.OrderMethodName).HasColumnName("PL_ORDER_METHOD").HasMaxLength(10);
            ...
            entity.Property(o => o.DeliveryAddressId).HasColumnName("DELIVERY_ADDRESS").HasMaxLength(38);
            entity.HasOne(o => o.DeliveryAddress).WithMany().HasForeignKey(o => o.DeliveryAddressId);
            entity.Property(o => o.RequestedById).HasColumnName("REQUESTED_BY").HasMaxLength(6);
            entity.HasOne(o => o.RequestedBy).WithMany().HasForeignKey(o => o.RequestedById);
            entity.Property(o => o.EnteredById).HasColumnName("ENTERED_BY").HasMaxLength(6);
            ...
            entity.Property(o => o.OrderAddressId).HasColumnName("ORDER_ADDRESS_ID").HasMaxLength(38);
            entity.HasOne(o => o.OrderAddress).WithMany().HasForeignKey(o => o.OrderAddressId);
            entity.Property(e => e.DamagesPercent).HasColumnName("DAMAGES_PERCENT").HasMaxLength(8);
            entity.Property(o => o.BaseCurrencyCode).HasColumnName("BASE_CURRENCY").HasMaxLength(4);
            entity.Property(o => o.OrderNetTotal).HasColumnName("ORDER_NET_TOTAL").HasMaxLength(18);
            entity.Property(o => o.BaseOrderNetTotal).HasColumnName("BASE_ORDER_NET_TOTAL").HasMaxLength(19);
            entity.Property(o => o.OrderVatTotal).HasColumnName("ORDER_VAT_TOTAL").HasMaxLength(18);
            entity.Property(o => o.InvoiceAddressId).HasColumnName("INVOICE_ADDRESS_ID").HasMaxLength(38);
        ...
        private void BuildPurchaseOrderLogs(ModelBuilder builder)
        {
            var entity = builder.Entity<PurchaseOrderLogEntry>().ToTable("PL_ORDERS_LOG");
            ...
            entity.Property(e => e.DocumentTypeName).HasColumnName("DOCUMENT_TYPE").HasMaxLength(50);
            entity.Property(e => e.OrderDate).HasColumnName("DATE_OF_ORDER");
            entity.Property(e => e.SupplierId).HasColumnName("SUPP_SUPPLIER_ID").HasMaxLength(6);
            entity.Property(e => e.Overbook).HasColumnName("OVERBOOK").HasMaxLength(1);
            entity.Property(e => e.OverbookQty).HasColumnName("OVERBOOK_QTY").HasMaxLength(19);
            entity.Property(e => e.CurrencyCode).HasColumnName("CURR_CODE").HasMaxLength(4);
            entity.Property(e => e.BaseCurrencyCode).HasColumnName("BASE_CURRENCY").HasMaxLength(4);
            entity.Property(e => e.OrderContactName).HasColumnName("CONTACT_NAME").HasMaxLength(52);
            entity.Property(e => e.OrderMethodName).HasColumnName("PL_ORDER_METHOD").HasMaxLength(10);
            entity.Property(e => e.ExchangeRate).HasColumnName("EXCHANGE_RATE").HasMaxLength(19);
            entity.Property(e => e.IssuePartsToSupplier).HasColumnName("ISSUE_PARTS_TO_SUPPLIER").HasMaxLength(1);
            entity.Property(e => e.DeliveryAddressId).HasColumnName("DELIVERY_ADDRESS").HasMaxLength(38);
            entity.Property(e => e.RequestedById).HasColumnName("REQUESTED_BY").HasMaxLength(6);
            entity.Property(e => e.EnteredById).HasColumnName("ENTERED_BY").HasMaxLength(6);
            entity.Property(e => e.QuotationRef).HasColumnName("QUOTATION_REF").HasMaxLength(50);
            entity.Property(e => e.AuthorisedById).HasColumnName("AUTHORISED_BY").HasMaxLength(6);
            entity.Property(e => e.SentByMethod).HasColumnName("SENT_BY_METHOD").HasMaxLength(20);
            entity.Property(e => e.Remarks).HasColumnName("REMARKS").HasMaxLength(500);
            entity.Property(e => e.DateFilCancelled).HasColumnName("DATE_FIL_CANCELLED");
            entity.Property(e => e.PeriodFilCancelled).HasColumnName("PERIOD_FIL_CANCELLED");
            entity.Property(e => e.OrderAddressId).HasColumnName("ORDER_ADDRESS_ID").HasMaxLength(38);
            entity.Property(e => e.InvoiceAddressId).HasColumnName("INVOICE_ADDRESS_ID").HasMaxLength(38);
            entity.Property(e => e.DamagesPercent).HasColumnName("DAMAGES_PERCENT").HasMaxLength(8);
            entity.Property(e => e.OrderNetTotal).HasColumnName("ORDER_NET_TOTAL").HasMaxLength(18);
            entity.Property(e => e.BaseOrderNetTotal).HasColumnName("BASE_ORDER_NET_TOTAL").HasMaxLength(19);
            entity.Property(e => e.OrderVatTotal).HasColumnName("ORDER_VAT_TOTAL").HasMaxLength(18);
            entity.Property(e => e.OrderTotal).HasColumnName("ORDER_TOTAL").HasMaxLength(18);
            entity.Property(e => e.BaseOrderVatTotal).HasColumnName("BASE_ORDER_VAT_TOTAL").HasMaxLength(18);
            entity.Property(e => e.BaseOrderTotal).HasColumnName("BASE_ORDER_TOTAL").HasMaxLength(18);
            entity.Property(e => e.ArchiveOrder).HasColumnName("ARCHIVE_ORDER").HasMaxLength(1);
        }
        ...
        private void BuildPurchaseOrderDetailLogs(ModelBuilder builder)
        {
            var entity = builder.Entity<PurchaseOrderDetailLogEntry>().ToTable("PL_ORDER_DETAILS_LOG");
            entity.HasKey(e => e.LogId);
            entity.Property(e => e.LogId).HasColumnName("LOG_ID");
            entity.Property(e => e.LogUserNumber).HasColumnName("LOG_USER_NUMBER").HasMaxLength(10);
            entity.Property(e => e.LogAction).HasColumnName("LOG_ACTION").HasMaxLength(50);
            ...
            entity.Property(e => e.OrderNumber).HasColumnName("ORDER_NUMBER").HasMaxLength(10);
            entity.Property(e => e.Line).HasColumnName("ORDER_LINE").HasMaxLength(6);
            entity.Property(e => e.DrawingReference).HasColumnName("DRAWING_REF").HasMaxLength(100);
            entity.Property(e => e.SuppliersDesignation).HasColumnName("SUPPLIERS_DESIGNATION").HasMaxLength(2000);
            entity.Property(e => e.OurQty).HasColumnName("OUR_QTY").HasMaxLength(19);
            entity.Property(e => e.OrderQty).HasColumnName("ORDER_QTY").HasMaxLength(19);
            entity.Property(e => e.VatTotalCurrency).HasColumnName("VAT_TOTAL").HasMaxLength(18);
            entity.Property(e => e.OurUnitOfMeasure).HasColumnName("OUR_UNIT_OF_MEASURE").HasMaxLength(14);
            entity.Property(e => e.OrderUnitOfMeasure).HasColumnName("ORDER_UNIT_OF_MEASURE").HasMaxLength(14);
            entity.Property(e => e.OrderConversionFactor).HasColumnName("ORDER_CONV_FACTOR").HasMaxLength(19);
            entity.Property(e => e.PartNumber).HasColumnName("PART_NUMBER").HasMaxLength(14);
            entity.Property(e => e.PriceType).HasColumnName("PRICE_TYPE").HasMaxLength(10);
            entity.Property(e => e.QuotationRef).HasColumnName("QUOTATION_REF").HasMaxLength(50);
            entity.Property(e => e.Cancelled).HasColumnName("CANCELLED").HasMaxLength(1);
            entity.Property(e => e.FilCancelled).HasColumnName("FIL_CANCELLED").HasMaxLength(1);
            entity.Property(e => e.UpdatePartsupPrice).HasColumnName("UPDATE_PARTSUP_PRICE").HasMaxLength(1);
            entity.Property(e => e.IssuePartsToSupplier).HasColumnName("ISSUE_PARTS_TO_SUPPLIER").HasMaxLength(1);
            entity.Property(e => e.WasPreferredSupplier).HasColumnName("WAS_PREFERRED_SUPPLIER").HasMaxLength(1);
            entity.Property(e => e.DeliveryInstructions).HasColumnName("DELIVERY_INSTRUCTIONS").HasMaxLength(200);
            entity.Property(e => e.NetTotalCurrency).HasColumnName("NET_TOTAL").HasMaxLength(18);
            entity.Property(e => e.DetailTotalCurrency).HasColumnName("DETAIL_TOTAL").HasMaxLength(18);
            entity.Property(e => e.StockPoolCode).HasColumnName("STOCK_POOL_CODE").HasMaxLength(10);
            entity.Property(e => e.OriginalOrderNumber).HasColumnName("ORIGINAL_ORDER_NUMBER").HasMaxLength(8);
            entity.Property(e => e.OriginalOrderLine).HasColumnName("ORIGINAL_ORDER_LINE").HasMaxLength(6);
            entity.Property(e => e.BaseOurUnitPrice).HasColumnName("BASE_OUR_UNIT_PRICE").HasMaxLength(19);
            entity.Property(e => e.BaseOrderUnitPrice).HasColumnName("BASE_ORDER_UNIT_PRICE").HasMaxLength(19);
            entity.Property(e => e.BaseNetTotal).HasColumnName("BASE_NET_TOTAL").HasMaxLength(18);
            entity.Property(e => e.BaseDetailTotal).HasColumnName("BASE_DETAIL_TOTAL").HasMaxLength(18);
            entity.Property(e => e.BaseVatTotal).HasColumnName("BASE_VAT_TOTAL").HasMaxLength(18);
            entity.Property(e => e.DateFilCancelled).HasColumnName("DATE_FIL_CANCELLED");
            entity.Property(e => e.PeriodFilCancelled).HasColumnName("PERIOD_FIL_CANCELLED");
        ...
        private void BuildBomDetails(ModelBuilder builder)
        {
            ...
            entity.Property(a => a.DeleteReplaceSeq).HasColumnName("DELETE_REPLACE_SEQ");
            entity.Property(a => a.PcasLine).HasColumnName("PCAS_LINE");
            entity.HasOne(a => a.Part).WithMany().HasForeignKey(x => x.PartNumber);

    ...
    return (
        <Page homeUrl={config.appRoot} history={history}>
            ...
            <List>
                ...
                <ListItem component={Link} to="/purchasing/suppliers" button>
                    <Typography color="primary">Supplier Utility</Typography>
                </ListItem>
                ...
                <ListItem component={Link} to="/purchasing/boms/boards-summary" button>
                    <Typography color="primary">Boards Summary</Typography>
                </ListItem>

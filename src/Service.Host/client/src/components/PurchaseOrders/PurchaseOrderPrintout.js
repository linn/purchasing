...
//                                 <Text style={styles.fourColumns}>
//                                     <b>PURCHASE ORDER</b>
//                                 </Text>
//                                 <Text style={styles.forColumns}>
//                                     Date: {item.orderDate}
//                                     {/* ?.toDateString() */}
//                                 </Text>
//                             </View>
...
//                                 <Text style={styles.sixColumns}>
//                                     {item.orderAddress.addressLine1}
//                                 </Text>
//                             </View>
//                             <View style={[styles.addressRow]}>
//                                 <Text style={styles.sixColumns}>
//                                     {item.orderAddress.addressLine2}
//                                 </Text>
//                             </View>
//                             <View style={[styles.addressRow]}>
//                                 <Text style={styles.sixColumns}>
//                                     {item.orderAddress.addressLine3}
//                                 </Text>
//                             </View>
//                             <View style={[styles.addressRow]}>
//                                 <Text style={styles.sixColumns}>
//                                     {item.orderAddress.addressLine4}
//                                 </Text>
//                             </View>
//                             <View style={[styles.addressRow]}>
//                                 <Text style={styles.sixColumns}>{item.orderAddress.postCode}</Text>
//                             </View>
//                             <View style={[styles.addressRow]}>
//                                 <Text style={styles.sixColumns}>
//                                     {item.orderAddress.country?.countryName}
//                                 </Text>
//                             </View> */}
...
//                                 <Text style={styles.eightColumns}>{item.orderContactName}</Text>
//                             </View>
//                             <View style={[styles.row]}>
//                                 <Text style={styles.labelTwoColumns}>Entered By:</Text>
//                                 <Text style={styles.eightColumns}>
//                                     {item.requestedBy?.fullName}
//                                 </Text>
//                             </View>
//                             <View style={[styles.row]}>
//                                 <Text style={styles.labelTwoColumns}>Auth By:</Text>
//                                 <Text style={styles.eightColumns}>
...
//                             <View style={[styles.row]}>
//                                 <Text style={styles.labelTwoColumns}>Quotation Ref:</Text>
//                                 <Text style={styles.eightColumns}>{item.quoteRef}</Text>
//                             </View>
//                             <View style={[styles.row]}>
//                                 <Text style={styles.labelTwoColumns}>remarks:</Text>
//                                 <Text style={styles.eightColumns}>{item.remarks}</Text>
//                             </View>

//                             {item.details.map(detail => (
//                                 <>
//                                     <View style={[styles.row]}>
//                                         <Text style={styles.labelTwoColumns}>
//                                             Order Line: {detail.lineNumber}
//                                         </Text>
//                                     </View>
//                                     <View style={[styles.row]}>
//                                         <Text style={styles.labelTwoColumns}>

...
function PurchaseOrderUtility({ creating }) {
    ...
    const handleAuthorise = () => {
        ...
        if (allowedToAuthorise) {
            clearErrors();
            dispatch(
                purchaseOrderActions.postByHref(order.links?.find(l => l.rel === 'authorise')?.href)
            );
        }
    };
    ...
    const handleCancelClick = () => {
        if (allowedToCancel) {
            clearErrors();
            dispatch(
                purchaseOrderActions.postByHref(order.links.find(l => l.rel === 'cancel').href)
            );
        }
    };
                    ...
                    <Grid container spacing={2} justifyContent="center">
                        ...
                        <Grid item xs={1}>
                            <Tooltip title="Print Order screen">
                                <IconButton
                                    ...
                                    onClick={() =>
                                        history.push(
                                            order.links?.find(l => l.rel === 'print')?.href
                                        )
                                    }
                                    disabled
                                    //={creating}
                        ...
                        <Grid item xs={4}>
                            <TypeaheadTable
                                ...
                                value={order.nominal?.nominalCode}
                        ...
                        <Grid item xs={8}>
                            <InputField
                                fullWidth
                                value={order.nominal?.description}
                                label="Description"
                                disabled
                                onChange={handleFieldChange}
                        ...
                        <Grid item xs={4}>
                            <InputField
                                fullWidth
                                value={order.department?.departmentCode}
                                label="Dept"
                                onChange={() => {}}
                        ...
                        <Grid item xs={8}>
                            <InputField
                                fullWidth
                                value={order.department?.description}
                                label="Description"

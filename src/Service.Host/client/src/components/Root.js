                ...
                <Provider store={store}>
                    <OidcProvider store={store} userManager={userManager}>
                        <>
                            ...
                            />
                            <Route exact path="/purchasing/suppliers/:id" component={Supplier} />
                            <Route
                                exact
                            ...
                            />
                            <Route exact path="/purchasing/addresses" component={AddressUtility} />
                            <Route
                                exact
                            ...
                            <Route
                                ...
                                component={Note}
                            />
                            <Route exact path="/purchasing/boms/boards" component={BoardSearch} />
                            <Route
                                exact
                            ...
                            <Route exact path="/purchasing/boms/tree" component={BomTreeReport} />
                            <Route
                                exact

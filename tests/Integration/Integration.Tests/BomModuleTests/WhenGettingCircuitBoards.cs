namespace Linn.Purchasing.Integration.Tests.BomModuleTests
{
    ...
    public class WhenGettingCircuitBoards : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            this.CircuitBoardRepository.FindAll().Returns(new List<CircuitBoard> { board }.AsQueryable());
        ...
        {
            this.CircuitBoardRepository.Received().FindAll();
        }

namespace Linn.Purchasing.Integration.Tests.BomModuleTests
{
    ...
    public class WhenUpdatingCircuitBoardComponents : ContextBase
    {
        ...
        [Test]
        public void ShouldTryAndGetPcasChange()
        {
            this.PcasChangeRepository.Received().FindBy(Arg.Any<Expression<Func<PcasChange, bool>>>());
        }

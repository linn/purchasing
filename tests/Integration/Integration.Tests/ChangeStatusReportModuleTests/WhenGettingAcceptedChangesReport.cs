namespace Linn.Purchasing.Integration.Tests.ChangeStatusReportModuleTests
{
    ...
    public class WhenGettingAcceptedChanges : ContextBase
    {
        private int months;
        ...
        public void SetUp()
        {
            ...
            this.DomainService
                .GetAcceptedChangesReport(this.months)
                .Returns(reportResult);

            this.Response = this.Client.Get(
                $"/purchasing/reports/accepted-changes/report?months={this.months}",
        ...
        {
            this.DomainService.Received().GetAcceptedChangesReport(
                this.months);
        }

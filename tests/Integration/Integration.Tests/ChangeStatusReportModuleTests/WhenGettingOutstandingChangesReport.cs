namespace Linn.Purchasing.Integration.Tests.ChangeStatusReportModuleTests
{
    ...
    public class WhenGettingOutstandingChanges : ContextBase
    {
        private int months;
        ...
        public void SetUp()
        {
            ...
            this.DomainService
                .GetTotalOutstandingChangesReport(this.months)
                .Returns(reportResult);

            this.Response = this.Client.Get(
                $"/purchasing/reports/outstanding-changes/report?months={this.months}",
        ...
        {
            this.DomainService.Received().GetTotalOutstandingChangesReport(
                this.months);
        }

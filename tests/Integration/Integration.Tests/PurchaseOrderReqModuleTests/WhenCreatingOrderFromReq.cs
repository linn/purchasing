namespace Linn.Purchasing.Integration.Tests.PurchaseOrderReqModuleTests
{
    ...
    public class WhenCreatingOrderFromReq : ContextBase
    {
            ...
            this.resource = new PurchaseOrderReqResource
                                {
                                    ...
                                    SecondAuthBy = null,
                                    FinanceCheckBy = new EmployeeResource { Id = 33107, FullName = "me" },
                                    TurnedIntoOrderBy = new EmployeeResource { Id = 33107, FullName = "me" },
        ...
        public void ShouldReturnJsonBody()
        {
            ...
            resultResource.TurnedIntoOrderBy.Id.Should().Be(this.resource.TurnedIntoOrderBy.Id);

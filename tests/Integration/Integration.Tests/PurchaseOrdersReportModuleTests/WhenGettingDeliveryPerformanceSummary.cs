namespace Linn.Purchasing.Integration.Tests.PurchaseOrdersReportModuleTests
{
    ...
    public class WhenGettingDeliveryPerformanceSummary : ContextBase
    {
        [SetUp]
        public void SetUp()
        {
            ...
            this.FacadeService
                .GetDeliveryPerformanceSummaryReport(Arg.Any<DeliveryPerformanceRequestResource>())
                .Returns(new SuccessResult<ReportReturnResource>(reportReturnResource));

            this.Response = this.Client.Get(
                "/purchasing/reports/delivery-performance-summary/report?startPeriod=2&endPeriod=4&supplierId=123&vendorManager=VM1",
        ...
        {
            this.FacadeService.Received().GetDeliveryPerformanceSummaryReport(

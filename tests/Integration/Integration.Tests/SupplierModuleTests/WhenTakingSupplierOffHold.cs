namespace Linn.Purchasing.Integration.Tests.SupplierModuleTests
{
    ...
    public class WhenTakingSupplierOffHold : ContextBase
    {
        ...
        [Test]
        public void ShouldNotGetSeqNextVal()
        {
            this.MockDatabaseService.DidNotReceive().GetNextVal("SOHH_SEQ");
        }
        ...
        public void ShouldCallDomainService()
        {
            this.MockDomainService.Received().ChangeSupplierHoldStatus(
                Arg.Is<SupplierOrderHoldHistoryEntry>(e =>
                    e.SupplierId == 1
                    && e.TakenOffHoldBy == 33087
                    && e.ReasonOffHold == this.resource.ReasonOffHold),

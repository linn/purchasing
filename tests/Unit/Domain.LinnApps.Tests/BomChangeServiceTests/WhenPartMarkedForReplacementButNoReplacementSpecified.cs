namespace Linn.Purchasing.Domain.LinnApps.Tests.BomChangeServiceTests
{
    ...
    public class WhenPartMarkedForReplacementButNoReplacementSpecified : ContextBase
    {
        ...
        public void ShouldThrow()
        {
            this.action.Should().Throw<InvalidBomChangeException>()
                .WithMessage("CAP OLD is marked for replacement but no replacement part is specified");
        }
    }
}

namespace Linn.Purchasing.Domain.LinnApps.Tests.BomChangeServiceTests
{
    ...
    public class WhenReplacingBomDetailWithZeroNewQty : ContextBase
    {
        private Bom bom;
        ...
        public void SetUp()
        {
            ...
            this.Sut.ReplaceBomDetail(1, this.request, 7004, 0);
        }
        ...
        [Test]
        public void ShouldNotAddNewBomDetail()
        {
            this.BomDetailRepository.DidNotReceive().Add(Arg.Any<BomDetail>());
        }
    }
}

namespace Linn.Purchasing.Domain.LinnApps.Tests.BomChangeServiceTests
{
    ...
    public class WhenReplacingPartThatWasAddedByTheCurrentChangeRequest : ContextBase
    {
        ...
        public void ShouldThrow()
        {
            this.action.Should().Throw<InvalidBomChangeException>()
                .WithMessage(
                    "CAP OLD was added by the current change request - no need to replace it - just edit it directly.");
        }
    }
}

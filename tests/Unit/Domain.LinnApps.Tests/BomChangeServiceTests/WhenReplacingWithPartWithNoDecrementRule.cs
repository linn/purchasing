namespace Linn.Purchasing.Domain.LinnApps.Tests.BomChangeServiceTests
{
    ...
    public class WhenReplacingWithPartWithNoDecrementRule : ContextBase
    {
        ...
        public void ShouldThrow()
        {
            this.action.Should().Throw<InvalidBomChangeException>()
                .WithMessage($"Can't add CAP NEW to BOM - part has no decrement rule!");
        }
    }
}

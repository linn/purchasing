namespace Linn.Purchasing.Domain.LinnApps.Tests.BomReportsServiceTests
{
    ...
    public class WhenGettingBoardDifference : ContextBase
    {
        ...
        public void ShouldReturnReport()
        {
            ...
            this.results.GetGridTextValue(2, 4).Should().Be("CAP 126");
            this.results.GetGridTextValue(2, 5).Should().Be("Capacitor 126");
            this.results.GetGridTextValue(2, 6).Should().Be("SM");
            this.results.GetGridTextValue(2, 7).Should().Be("1.0");
        }
    }
}

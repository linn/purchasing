namespace Linn.Purchasing.Domain.LinnApps.Tests.BomTreeServiceTests
{
    ...
    public class WhereUsedContextBase
    {
        ...
        */
            var rootChildren = new List<BomDetail>
                                      {
                                          new BomDetail { ChangeState = "LIVE", BomPart = new Part { PartNumber = "n1" } },
                                          new BomDetail { ChangeState = "LIVE", BomPart = new Part { PartNumber = "n2" } },
                                          new BomDetail { ChangeState = "LIVE", BomPart = new Part { PartNumber = "n3" } }
                                      };

            var n1Children = new List<BomDetail>
                                 {
                                     new BomDetail { ChangeState = "LIVE", BomPart = new Part { PartNumber = "n11" } },
                                     new BomDetail { ChangeState = "LIVE", BomPart = new Part { PartNumber = "n12" } },
                                     new BomDetail { ChangeState = "LIVE", BomPart = new Part { PartNumber = "n13" } }
                                 };

            var n11Children = new List<BomDetail>
                                  {
                                      new BomDetail { ChangeState = "LIVE", BomPart = new Part { PartNumber = "n111" } },
                                      new BomDetail { ChangeState = "LIVE", BomPart = new Part { PartNumber = "n112" } }
                                  };

            var n13Children = new List<BomDetail>
                                  {
                                      new BomDetail { ChangeState = "LIVE", BomPart = new Part { PartNumber = "n131" } }
                                  };

            var n111Children = new List<BomDetail>
                                  {
                                      new BomDetail { ChangeState = "LIVE", BomPart = new Part { PartNumber = "n1111" } }
                                  };

            var n112Children = new List<BomDetail>
                                   {
                                       new BomDetail { ChangeState = "LIVE", BomPart = new Part { PartNumber = "n1121" } }
                                   };

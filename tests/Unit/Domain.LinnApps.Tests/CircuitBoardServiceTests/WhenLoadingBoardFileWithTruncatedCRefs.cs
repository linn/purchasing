namespace Linn.Purchasing.Domain.LinnApps.Tests.CircuitBoardServiceTests
{
    ...
    public class WhenLoadingBoardFileWithTruncatedCRefs : ContextBase
    {
...
""BR10""	""MISS266""	""D15XB60H 15A 600V BRIDGE DIODE SINGLE IN LINE PACKAGE""	""D15XBXXHV""	""""	""""	""""	""TH""	""""	""""	""""	""""
""C2""	""RES966""	""RES""	""BBBB""	""""	""""	""""	""TH""	""""	""""	""""	""""
""CD1234""	""RES1234""	""RES""	""BBBB""	""""	""""	""""	""TH""	""""	""""	""""	""""";
        ...
        public void ShouldMakeSuggestedChangesMessage()
        {
            ...
            this.result.Message.Should().Contain("Adding RES 1234 at CD1234.");
            this.result.Message.Should().Contain("Adding MISS 266 at BR010.");

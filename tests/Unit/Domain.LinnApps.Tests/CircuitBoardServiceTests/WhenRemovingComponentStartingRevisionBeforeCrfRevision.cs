namespace Linn.Purchasing.Domain.LinnApps.Tests.CircuitBoardServiceTests
{
    ...
    public class WhenRemovingComponentStartingRevisionBeforeCrfRevision : ContextBase
    {
        ...
        public void ShouldMarkAsDeletedAndAddNewComponent()
        {
            ...
            added.ToLayoutVersion.Should().Be(1);
            added.FromRevisionVersion.Should().Be(1);
            added.ToRevisionVersion.Should().Be(1);
        }
    }
}

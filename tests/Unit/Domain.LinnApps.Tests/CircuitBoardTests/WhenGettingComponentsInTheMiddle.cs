namespace Linn.Purchasing.Domain.LinnApps.Tests.CircuitBoardTests
{
    ...
    public class WhenGettingComponentsInTheMiddle : ContextBase
    {
        ...
        {
            this.results.Should().HaveCount(7);
            this.results.Select(a => a.BoardLine).Should().Contain(3);
            this.results.Select(a => a.BoardLine).Should().Contain(4);
            this.results.Select(a => a.BoardLine).Should().Contain(5);
            this.results.Select(a => a.BoardLine).Should().Contain(7);
            this.results.Select(a => a.BoardLine).Should().Contain(8);
            this.results.Select(a => a.BoardLine).Should().Contain(9);

namespace Linn.Purchasing.Domain.LinnApps.Tests.MaterialRequirementsReportServiceTests
{
    ...
    public class WhenGettingReportForLateOrders : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            this.MrHeaderRepository.FilterBy(Arg.Any<Expression<Func<MrHeader, bool>>>()).Returns(
                new List<MrHeader>
                    {
                        new MrHeader { PartNumber = "P1", LatePurchaseOrders = 0 },
                        new MrHeader { PartNumber = "P2", LatePurchaseOrders = null },
                        new MrHeader { PartNumber = "P3", LatePurchaseOrders = 1 },
                        new MrHeader { PartNumber = "P4", LatePurchaseOrders = 300.34m }
                    }.AsQueryable());
        ...
        public void ShouldReturnReport()
        {
            ...
            this.result.Headers.Should().Contain(a => a.PartNumber == "P4");
        }
    }
}

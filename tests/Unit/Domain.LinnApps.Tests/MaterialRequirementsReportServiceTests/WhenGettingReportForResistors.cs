namespace Linn.Purchasing.Domain.LinnApps.Tests.MaterialRequirementsReportServiceTests
{
    ...
    public class WhenGettingReportForResistors : ContextBase
    {
                ...
                new List<MrHeader>
                    {
                        ...
                        new MrHeader { PartNumber = "RES2" },
                        new MrHeader { PartNumber = "P3" },
                        new MrHeader { PartNumber = "RES 343" }
                    }.AsQueryable());
        ...
        public void ShouldReturnReport()
        {
            ...
            this.result.Headers.Should().Contain(a => a.PartNumber == "RES2");
            this.result.Headers.Should().Contain(a => a.PartNumber == "RES 343");
        }
    }
}

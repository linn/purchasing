namespace Linn.Purchasing.Domain.LinnApps.Tests.PurchaseOrderReqServiceTests
{
    ...
    public class WhenAuthorisingButNotAllowed : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            this.MockPurchaseOrderReqsPack.AllowedToAuthorise(
               ...
               147m,
                ...
                this.fromState).Returns(new AllowedToAuthoriseReqResult { Success = false, Message = "You are not authorised" });
        ...
        {
            this.action.Should().Throw<UnauthorisedActionException>().WithMessage("You are not authorised");
        }
    }
}

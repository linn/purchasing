namespace Linn.Purchasing.Domain.LinnApps.Tests.PurchaseOrderReqServiceTests
{
    ...
    public class WhenAuthorisingNoNominal : ContextBase
    {
        private readonly int authoriserUserNumber = 2143;
        ...
        public void ShouldThrowUnauthorisedException()
        {
            this.action.Should().Throw<PurchaseOrderReqException>()
                .WithMessage("Please enter Nominal & Department before Authorising");
        }
    }
}

namespace Linn.Purchasing.Domain.LinnApps.Tests.PurchaseOrderReqServiceTests
{
    ...
    public class WhenAuthorisingOwnRequest : ContextBase
    {
        ...
        {
            this.action.Should().Throw<UnauthorisedActionException>().WithMessage("You cannot authorise a req that was requested by yourself");
        }
    }
}

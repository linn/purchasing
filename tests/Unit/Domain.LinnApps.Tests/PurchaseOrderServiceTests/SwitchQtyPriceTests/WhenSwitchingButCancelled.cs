namespace Linn.Purchasing.Domain.LinnApps.Tests.PurchaseOrderServiceTests.SwitchQtyPriceTests
{
    ...
    public class WhenSwitchingButCancelled : SwitchQtyPriceContextBase
    {
        [SetUp]
        public void SetUp()
        {
        ...
        public void ShouldThrowException()
        {
            this.Action.Should().Throw<InvalidActionException>()
                .WithMessage($"Cannot switch qty and price on order {this.OrderNumber}/1 because line is cancelled.");
        }
    }
}

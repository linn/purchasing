namespace Linn.Purchasing.Domain.LinnApps.Tests.PurchaseOrderServiceTests.SwitchQtyPriceTests
{
    ...
    public class WhenSwitchingButStockControlled : SwitchQtyPriceContextBase
    {
        [SetUp]
        public void SetUp()
        {
                                                 ...
                                                 new PurchaseOrderDetail
                                                     {
                                                         ...
                                                         Line = 1,
                                                         Part = new Part { PartNumber = "P1", StockControlled = "Y" },
                                                         PartNumber = "P1",
                                                         OrderQty = 1,
                                                         OurQty = 1,
        ...
        public void ShouldThrowException()
        {
            this.Action.Should().Throw<InvalidActionException>()
                .WithMessage($"Cannot switch qty and price on order {this.OrderNumber}/1 because P1 is stock controlled.");
        }
    }
}

namespace Linn.Purchasing.Domain.LinnApps.Tests.PurchaseOrderServiceTests
{
    ...
    public class WhenEmailingDeptAndOrderNotFound : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            this.PurchaseOrderRepository.FindById(this.order.OrderNumber).ReturnsNull();
        ...
        public void ShouldThrowException()
        {
            this.action.Should().Throw<ItemNotFoundException>()
                .WithMessage($"Could not find order {this.order.OrderNumber}");
        }
    }
}

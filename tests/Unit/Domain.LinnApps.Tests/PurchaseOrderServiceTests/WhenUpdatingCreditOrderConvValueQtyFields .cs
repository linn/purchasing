namespace Linn.Purchasing.Domain.LinnApps.Tests.PurchaseOrderServiceTests
{
    ...
    public class WhenUpdatingCreditOrderConvValueQtyFields : ContextBase
    {
            ...
            this.current = new PurchaseOrder
                               {
                                   ...
                                   DocumentType = new DocumentType
                                                      {
                                                          Description = "Regular Credit Order",
                                                          Name = "CO"
                                                      },
                                   DocumentTypeName = "CO",
        ...
        public void ShouldNotUpdateFieldsForOrders()
        {
            ...
            // Item should not have been updated from 120 as credit order
        ...
        public void ShouldNotUpdateMiniOrderFields()
        {
            ...
            // should not have been updated as credit order

namespace Linn.Purchasing.Domain.LinnApps.Tests.SupplierServiceTests
{
    ...
    public class WhenDeletingAContactLeavesNoMainInvoiceContact : AuthorisedContext
    {
        ...
        public void Setup()
        {
            this.toDelete = new SupplierContact { ContactId = 123, Person = new Person(), IsMainInvoiceContact = "Y" };
        ...
        public void ShouldThrowException()
        {
            this.action.Should().Throw<SupplierException>()
                .WithMessage("The inputs for the following fields are empty/invalid: Main Invoice Contact, ");
        }
    }
}

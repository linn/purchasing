namespace Linn.Purchasing.Facade.Tests.PurchaseOrdersReportServiceTests
{
    ...
    public class WhenGettingDeliveryPerformanceSummaryReport : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            this.DeliveryPerformanceReportService.GetDeliveryPerformanceSummary(this.startPeriod, this.endPeriod, this.supplierId, this.vendorManager)
                .Returns(new ResultsModel { ReportTitle = new NameModel("Title") });
            this.result = this.Sut.GetDeliveryPerformanceSummaryReport(this.requestResource);
        }
        ...
        public void ShouldCallDomainService()
        {
            this.DeliveryPerformanceReportService
                .Received()
                .GetDeliveryPerformanceSummary(this.startPeriod, this.endPeriod, this.supplierId, this.vendorManager);
        }
